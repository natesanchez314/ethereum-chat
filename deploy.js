...
let abi = compiled.contracts.example.nateChat.abi;
let bytecode = "0x" + compiled.contracts.example.nateChat.evm.bytecode.object;
...
let nateChatInstance = nateChatContractFactory.new (initialSupply, { 
